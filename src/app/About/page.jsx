...
export const metadata = {
  ...
  description: "Learn more about GetStrongerMe, our mission, and how we help small businesses grow online through affordable websites, SEO, and digital marketing services.",
};
    ...
    <section className="py-20 bg-white">
      ...
      {/* Our Mission */}
        ...
        <p className="text-gray-700 mb-4">
          At <strong>Strongerme</strong>, our mission is simple: to empower small businesses
          and start-ups in Johannesburg and across Gauteng by delivering affordable, effective, 
          and conversion-driven digital solutions. We aim to level the playing field for emerging businesses 
          by giving them access to high-quality websites, SEO, and digital tools that drive real growth.
        </p>

        {/* Our Vision */}
        <h4 className="text-2xl font-semibold mb-3">Our Vision</h4>
        <p className="text-gray-700 mb-6">
          Our vision is to become Gauteng’s most trusted digital partner for small businesses and entrepreneurs. 
          We see a future where every local business—no matter how small—can build a strong online presence, 
